...
class ObjectInfo {
  ObjectInfo({
    ...
    required List<ObjectProperty> properties, this.accessor,
...
class ObjectProperty {
  ObjectProperty({
    ...
    required this.isarType, required this.isId, required this.enumMap,
    required this.enumProperty, required this.defaultEnumElement,
    required this.nullable, required this.elementNullable,
     required this.deserialize, required this.assignable, this.targetIsarName,
...
class ObjectLink {
  const ObjectLink({
    required this.dartName,
    required this.isarName,
    required this.targetCollectionDartName, required this.targetCollectionIsarName,
    required this.isSingle, this.targetLinkIsarName,
  });
